/**
 * stable contracts injected into the desktop backup IPC flows.
 *
...
export interface DesktopDatabaseActionResult {
  ...
  path?: string;
  /**
   * bytes of the produced backup ZIP. Existing renderer callers
...
export interface BackupIpcDeps {
  ...
  /**
   * resolves (and caches) this install's SQLCipher key from the
