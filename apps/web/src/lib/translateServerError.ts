...
export const KNOWN_SERVER_ERROR_CODES = [
  ...
  'PRODUCT_TRACKING_HAS_REVERSIBLE_TRANSFORMATION',
  'PRODUCT_TRACKING_REQUIRES_EMPTY_INVENTORY',
  ...
  'INVENTORY_VALUE_CHANGED',
  'INVENTORY_VALUE_INVALID',
  'INVENTORY_COUNT_VALUE_CHANGED',
  'INVENTORY_COUNT_IDENTITY_TRACKING_REQUIRED',
  'INVENTORY_COUNT_IDENTITY_CHANGED',
  'INVENTORY_COUNT_IDENTITY_INVALID',
  'INVENTORY_COUNT_IDENTITY_LIMIT',
  ...
  'FISCAL_LINE_SNAPSHOT_UNKNOWN',
  'FISCAL_NUMBERING_RESOLUTION_UNUSABLE',
  ...
  'RESTAURANT_MODIFIER_UNAVAILABLE',
  'RESTAURANT_MODIFIER_APPROVAL_REQUIRED',
  'RESTAURANT_MODIFIER_CHANGED',
  'RESTAURANT_MODIFIER_LIMIT_REACHED',
  'RESTAURANT_MODIFIER_NAME_DUPLICATE',
