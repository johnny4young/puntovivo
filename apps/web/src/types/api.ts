// API/DTO layer of the former monolithic `types/index.ts`.
//
...
//
// The  split is intentionally conservative: the hand-written
...
// migration is deferred (follow-up). New DTOs
...
/**
 * one row of the admin fiscal-documents list
