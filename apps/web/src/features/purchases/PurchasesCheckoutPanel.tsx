    ...
    <div className="card p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-secondary-500">Review stock impact and provider registration before saving</p>
        </div>
      ...
      <div className="mt-6 space-y-4">
        <div className="rounded-xl border border-secondary-200 px-4 py-4">
          ...
          <div className="mt-3 flex items-center justify-between">
            <span className="text-secondary-500">Base units added</span>
        ...
        <div className="rounded-xl border border-secondary-200 px-4 py-4 text-sm">
          <p className="text-secondary-500">Receiving site</p>
        ...
        <div className="rounded-xl border border-dashed border-secondary-300 bg-secondary-50 px-4 py-4 text-sm text-secondary-600">
          Purchase costs update product cost history and increase stock using the selected unit equivalence.
        </div>
