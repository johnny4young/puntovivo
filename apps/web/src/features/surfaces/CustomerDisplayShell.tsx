 ...
 *
 * v1 keeps this surface BEHIND the auth shell (cashier role) so the
 * operator launches it from inside the authenticated session. A
 * future iteration may add an unauthenticated mode for public
 * second monitors.
 *
