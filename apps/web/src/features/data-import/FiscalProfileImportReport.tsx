  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex gap-3">
          ...
          <div>
            ...
            <h2
              id="fiscal-profile-report-title"
      ...
      <p
        ...
        data-testid="data-import-fiscal-activation-required"
      >
        {t('fiscalProfiles.activationReminder')}
      </p>
      <p
        className="mt-2 rounded-lg border border-warning-200 bg-warning-50 px-3 py-2 text-xs leading-5 text-warning-900"
