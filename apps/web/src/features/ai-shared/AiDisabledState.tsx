...
/**
 * Shared empty state per AI feature contract
 *
...
export function AiDisabledState({
  ...
  return (
    <section
      ...
      className={cn('card relative overflow-hidden p-6 sm:p-8', className)}
    >
      <div
        aria-hidden="true"
      ...
      <div className="relative">
        ...
        <p className="page-kicker mt-4">
          {t(`disabled.${feature}.kicker`, { defaultValue: t('disabled.role') })}
        </p>
