/**
 * Peripherals router — admin CRUD procedures (ENG-178 split).
 *
 * ENG-060 — register / update / setActive / test / remove for `site_peripherals`.
 *
...
import { instantiateAdapter, validatePeripheralConfig } from '../../../services/peripherals/index.js';
import { adminProcedure } from '../../middleware/roles.js';
import { ensureTenantSite } from '../../middleware/tenantSite.js';
import { registerPeripheralInput, removePeripheralInput, setPeripheralActiveInput, testPeripheralInput, updatePeripheralInput } from '../../schemas/peripherals.js';
