...
export const FORBIDDEN_SQL =
  /\b(insert|update|delete|drop|alter|create|replace|truncate|merge|upsert|pragma|attach|detach|vacuum|reindex|analyze|begin|commit|rollback|savepoint|release|load_extension|readfile)\b/i;
