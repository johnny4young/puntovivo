/**
 * Barrel de catálogos SII para el pack Chile.
 *
 ...
 * cuando llegue el modelado XML del DTE.
 *
 * @module services/fiscal/packs/cl/catalogs
 */

export { TIPO_DTE_CATALOG, findTipoDte, type TipoDteEntry } from './tipoDte.js';

export { GIRO_COMERCIAL_CATALOG, findGiroComercial, type GiroEntry } from './giroComercial.js';

export { COMUNA_CATALOG, COMUNA_FALLBACK, findComuna, type ComunaEntry } from './comuna.js';
