/**
 * Tests del validador RUT para el pack Chile.
 *
 * Cobertura:
...
describe('validateRut — inputs inválidos', () => {
...
describe('validateRut — RUT genérico extranjero', () => {
...
describe('validateRut — normalización', () => {
...
describe('validateRut — DV correctos', () => {
