...
export { validateRut, type RutValidationResult, type RutKind } from './rut.js';
export {
  TIPO_DTE_CATALOG,
...
export { serializeDte10, prettyPrintDte, type SerializedDte10 } from './dte10-xml.js';
export {
  computeDteTotals,
