...
export const SERVER_ERROR_CODES_B = {
  /** Unsupported company time zone; an administrator must correct or clear the override. */
   ...
   */
  RESTAURANT_MODIFIER_UNAVAILABLE: 'RESTAURANT_MODIFIER_UNAVAILABLE',
  RESTAURANT_MODIFIER_APPROVAL_REQUIRED: 'RESTAURANT_MODIFIER_APPROVAL_REQUIRED',
  RESTAURANT_MODIFIER_CHANGED: 'RESTAURANT_MODIFIER_CHANGED',
  RESTAURANT_MODIFIER_LIMIT_REACHED: 'RESTAURANT_MODIFIER_LIMIT_REACHED',
  RESTAURANT_MODIFIER_NAME_DUPLICATE: 'RESTAURANT_MODIFIER_NAME_DUPLICATE',
  ...
  CUSTOMER_LEDGER_INVALID_AMOUNT: 'CUSTOMER_LEDGER_INVALID_AMOUNT',
