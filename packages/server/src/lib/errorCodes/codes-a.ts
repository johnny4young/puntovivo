...
export const SERVER_ERROR_CODES_A = {
  ...
  SETUP_COUNTRY_INVALID: 'SETUP_COUNTRY_INVALID',
  SETUP_CSRF_REQUIRED: 'SETUP_CSRF_REQUIRED',
  SETUP_LOCAL_ACCESS_REQUIRED: 'SETUP_LOCAL_ACCESS_REQUIRED',
  ...
  AVAILABILITY_SCHEDULE_CONFLICT: 'AVAILABILITY_SCHEDULE_CONFLICT',
  AVAILABILITY_SCHEDULE_CHANGED: 'AVAILABILITY_SCHEDULE_CHANGED',
  AVAILABILITY_TEMPORARILY_UNAVAILABLE: 'AVAILABILITY_TEMPORARILY_UNAVAILABLE',
  SHIFT_SWAP_NOT_FOUND: 'SHIFT_SWAP_NOT_FOUND',
  SHIFT_SWAP_CHANGED: 'SHIFT_SWAP_CHANGED',
  SHIFT_SWAP_STATE_INVALID: 'SHIFT_SWAP_STATE_INVALID',
  SHIFT_SWAP_CLAIMED: 'SHIFT_SWAP_CLAIMED',
  SCHEDULE_PLAN_NOT_FOUND: 'SCHEDULE_PLAN_NOT_FOUND',
  SCHEDULE_PLAN_STATE_INVALID: 'SCHEDULE_PLAN_STATE_INVALID',
  SCHEDULE_PLAN_CHANGED: 'SCHEDULE_PLAN_CHANGED',
  SCHEDULE_RECURRENCE_INVALID: 'SCHEDULE_RECURRENCE_INVALID',
  SCHEDULE_AVAILABILITY_CONFLICT: 'SCHEDULE_AVAILABILITY_CONFLICT',
  TIME_OFF_NOT_FOUND: 'TIME_OFF_NOT_FOUND',
  TIME_OFF_WINDOW_INVALID: 'TIME_OFF_WINDOW_INVALID',
  TIME_OFF_OVERLAP: 'TIME_OFF_OVERLAP',
  TIME_OFF_SCHEDULE_CONFLICT: 'TIME_OFF_SCHEDULE_CONFLICT',
  TIME_OFF_STATE_INVALID: 'TIME_OFF_STATE_INVALID',
  TIME_OFF_SELF_APPROVAL: 'TIME_OFF_SELF_APPROVAL',
  TIME_OFF_TEMPORARILY_UNAVAILABLE: 'TIME_OFF_TEMPORARILY_UNAVAILABLE',
  SCHEDULE_TIME_OFF_CONFLICT: 'SCHEDULE_TIME_OFF_CONFLICT',
  EMPLOYMENT_CONTRACT_FORBIDDEN: 'EMPLOYMENT_CONTRACT_FORBIDDEN',
  EMPLOYMENT_CONTRACT_NOT_FOUND: 'EMPLOYMENT_CONTRACT_NOT_FOUND',
  EMPLOYMENT_CONTRACT_CURRENCY_MISMATCH: 'EMPLOYMENT_CONTRACT_CURRENCY_MISMATCH',
  EMPLOYMENT_CONTRACT_OVERLAP: 'EMPLOYMENT_CONTRACT_OVERLAP',
  EMPLOYMENT_CONTRACT_STATE_INVALID: 'EMPLOYMENT_CONTRACT_STATE_INVALID',
  EMPLOYMENT_CONTRACT_TEMPORARILY_UNAVAILABLE: 'EMPLOYMENT_CONTRACT_TEMPORARILY_UNAVAILABLE',
  PAYROLL_NOT_FOUND: 'PAYROLL_NOT_FOUND',
  PAYROLL_COUNTRY_UNSUPPORTED: 'PAYROLL_COUNTRY_UNSUPPORTED',
  PAYROLL_CURRENCY_MISMATCH: 'PAYROLL_CURRENCY_MISMATCH',
  PAYROLL_POLICY_UNAVAILABLE: 'PAYROLL_POLICY_UNAVAILABLE',
  PAYROLL_PERIOD_OVERLAP: 'PAYROLL_PERIOD_OVERLAP',
  PAYROLL_PROFILE_OVERLAP: 'PAYROLL_PROFILE_OVERLAP',
  PAYROLL_REGULAR_RUN_EXISTS: 'PAYROLL_REGULAR_RUN_EXISTS',
  PAYROLL_EMPLOYEE_SET_CHANGED: 'PAYROLL_EMPLOYEE_SET_CHANGED',
  PAYROLL_AUTHORITY_CHANGED: 'PAYROLL_AUTHORITY_CHANGED',
  PAYROLL_STATE_INVALID: 'PAYROLL_STATE_INVALID',
  PAYROLL_PREREQUISITES_INCOMPLETE: 'PAYROLL_PREREQUISITES_INCOMPLETE',
  PAYROLL_ADJUSTMENT_INVALID: 'PAYROLL_ADJUSTMENT_INVALID',
  PAYROLL_TEMPORARILY_UNAVAILABLE: 'PAYROLL_TEMPORARILY_UNAVAILABLE',

  EXTERNAL_ORDER_TEMPORARILY_UNAVAILABLE: 'EXTERNAL_ORDER_TEMPORARILY_UNAVAILABLE',
  EXTERNAL_ORDER_AUTH_INVALID: 'EXTERNAL_ORDER_AUTH_INVALID',
  EXTERNAL_ORDER_INPUT_INVALID: 'EXTERNAL_ORDER_INPUT_INVALID',
  EXTERNAL_ORDER_STATE_INVALID: 'EXTERNAL_ORDER_STATE_INVALID',
  EXTERNAL_ORDER_NOT_FOUND: 'EXTERNAL_ORDER_NOT_FOUND',
  EXTERNAL_ORDER_KEY_UNAVAILABLE: 'EXTERNAL_ORDER_KEY_UNAVAILABLE',
  RESERVATION_NOT_FOUND: 'RESERVATION_NOT_FOUND',
  RESERVATION_SLOT_CONFLICT: 'RESERVATION_SLOT_CONFLICT',
  RESERVATION_STATE_INVALID: 'RESERVATION_STATE_INVALID',
  RESERVATION_CAPACITY_EXCEEDED: 'RESERVATION_CAPACITY_EXCEEDED',
  RESERVATION_TABLE_HELD: 'RESERVATION_TABLE_HELD',
  DELIVERY_ORDER_NOT_FOUND: 'DELIVERY_ORDER_NOT_FOUND',
  DELIVERY_TRANSITION_INVALID: 'DELIVERY_TRANSITION_INVALID',
  DELIVERY_REFERENCE_INVALID: 'DELIVERY_REFERENCE_INVALID',
  DELIVERY_SALE_ALREADY_LINKED: 'DELIVERY_SALE_ALREADY_LINKED',
  DELIVERY_COURIER_REQUIRED: 'DELIVERY_COURIER_REQUIRED',
  ...
  ATTENDANCE_RECONCILIATION_NOT_FOUND: 'ATTENDANCE_RECONCILIATION_NOT_FOUND',
  ATTENDANCE_RECONCILIATION_RANGE_INVALID: 'ATTENDANCE_RECONCILIATION_RANGE_INVALID',
  ATTENDANCE_RECONCILIATION_PLAN_CHANGED: 'ATTENDANCE_RECONCILIATION_PLAN_CHANGED',
  ATTENDANCE_RECONCILIATION_ATTENDANCE_CLAIMED: 'ATTENDANCE_RECONCILIATION_ATTENDANCE_CLAIMED',
  ATTENDANCE_RECONCILIATION_NO_SHOW_EARLY: 'ATTENDANCE_RECONCILIATION_NO_SHOW_EARLY',
  ...
  SCHEDULE_SHIFT_RECONCILED: 'SCHEDULE_SHIFT_RECONCILED',
  SCHEDULE_TEMPORARILY_UNAVAILABLE: 'SCHEDULE_TEMPORARILY_UNAVAILABLE',
  ...
  // --- pharmacy policy, evidence and lot safety ---
  /** A medicine must use stock + lot tracking and cannot use serial tracking. */
  PHARMACY_PRODUCT_LOT_TRACKING_REQUIRED: 'PHARMACY_PRODUCT_LOT_TRACKING_REQUIRED',
  /** The selected product is not configured as a pharmacy medicine. */
  PHARMACY_PRODUCT_PROFILE_REQUIRED: 'PHARMACY_PRODUCT_PROFILE_REQUIRED',
  PHARMACY_PRODUCT_PROFILE_LOCKED: 'PHARMACY_PRODUCT_PROFILE_LOCKED',
  /** No reviewed country/date policy permits this regulated operation. */
  PHARMACY_POLICY_UNAVAILABLE: 'PHARMACY_POLICY_UNAVAILABLE',
  /** Controlled medicines remain disabled until an externally reviewed policy enables them. */
  PHARMACY_CONTROLLED_NOT_ENABLED: 'PHARMACY_CONTROLLED_NOT_ENABLED',
  /** The effective policy requires a sanitary registration on the product profile. */
  PHARMACY_PRODUCT_REGISTRATION_REQUIRED: 'PHARMACY_PRODUCT_REGISTRATION_REQUIRED',
  /** The product sanitary registration has expired on the tenant business day. */
  PHARMACY_PRODUCT_REGISTRATION_EXPIRED: 'PHARMACY_PRODUCT_REGISTRATION_EXPIRED',
  /** The effective policy requires a tenant-owned customer on the sale. */
  PHARMACY_CUSTOMER_REQUIRED: 'PHARMACY_CUSTOMER_REQUIRED',
  /** Prescription evidence encryption is not configured for this runtime. */
  PHARMACY_EVIDENCE_KEY_UNAVAILABLE: 'PHARMACY_EVIDENCE_KEY_UNAVAILABLE',
  PHARMACY_EVIDENCE_NOT_FOUND: 'PHARMACY_EVIDENCE_NOT_FOUND',
  PHARMACY_EVIDENCE_ALREADY_EXISTS: 'PHARMACY_EVIDENCE_ALREADY_EXISTS',
  PHARMACY_EVIDENCE_INVALID: 'PHARMACY_EVIDENCE_INVALID',
  PHARMACY_EVIDENCE_STATE_INVALID: 'PHARMACY_EVIDENCE_STATE_INVALID',
  PHARMACY_EVIDENCE_NOT_APPROVED: 'PHARMACY_EVIDENCE_NOT_APPROVED',
  PHARMACY_EVIDENCE_EXPIRED: 'PHARMACY_EVIDENCE_EXPIRED',
  PHARMACY_EVIDENCE_CUSTOMER_MISMATCH: 'PHARMACY_EVIDENCE_CUSTOMER_MISMATCH',
  PHARMACY_EVIDENCE_PRODUCT_MISMATCH: 'PHARMACY_EVIDENCE_PRODUCT_MISMATCH',
  PHARMACY_EVIDENCE_QUANTITY_EXCEEDED: 'PHARMACY_EVIDENCE_QUANTITY_EXCEEDED',
  /** Supplied evidence was duplicated or does not match any regulated line. */
  PHARMACY_EVIDENCE_SELECTION_INVALID: 'PHARMACY_EVIDENCE_SELECTION_INVALID',
  PHARMACY_AUTHORIZATION_NOT_FOUND: 'PHARMACY_AUTHORIZATION_NOT_FOUND',
  PHARMACY_AUTHORIZATION_SUBJECT_INVALID: 'PHARMACY_AUTHORIZATION_SUBJECT_INVALID',
  PHARMACY_AUTHORIZATION_DUPLICATE: 'PHARMACY_AUTHORIZATION_DUPLICATE',
  PHARMACY_AUTHORIZATION_NOT_EFFECTIVE: 'PHARMACY_AUTHORIZATION_NOT_EFFECTIVE',
  PHARMACY_AUTHORIZATION_INVALID: 'PHARMACY_AUTHORIZATION_INVALID',
  PHARMACY_AUTHORIZATION_STATE_INVALID: 'PHARMACY_AUTHORIZATION_STATE_INVALID',
  PHARMACY_RECALL_NO_LOTS: 'PHARMACY_RECALL_NO_LOTS',
  PHARMACY_RECALL_NOT_FOUND: 'PHARMACY_RECALL_NOT_FOUND',
  PHARMACY_RECALL_ACTIVE: 'PHARMACY_RECALL_ACTIVE',
  PHARMACY_LOT_STATE_INVALID: 'PHARMACY_LOT_STATE_INVALID',
  ...
  PROVIDER_HAS_PAYABLE_HISTORY: 'PROVIDER_HAS_PAYABLE_HISTORY',
