...
> Updated: 2026-09-22. This is the public source of truth for shipped
...
| Controlled internal beta       | **Ready with release checks** | [v1.14.4](https://github.com/johnny4young/puntovivo/releases/tag/v1.14.4) is published; the [live update policy](https://johnny4young.github.io/puntovivo/update-policy.json) and platform feeds offer it at 10 percent. Its [release workflow](https://github.com/johnny4young/puntovivo/actions/runs/35138577582) passed, but hosted packaging is not representative-host installation or updater proof. The documented v1.10.1 [packaged/recovery matrix](https://github.com/johnny4young/puntovivo/actions/runs/31264233582) is historical regression evidence, not evidence for the v1.14.4 binary. A fail-closed, hash-bound Gate 5 contract and standalone Electron runner exist; no approved v1.14.4 clean-install, production-updater upgrade, and real downgrade-refusal manifest is linked here. Complete Gate 5 on representative machines before promoting the rollout beyond 10 percent. |
...
- Keep cross-platform packaging, runtime-smoke, signing,
  ...
  artifacts. The documented v1.10.1 recovery matrix predates the current
  v1.14.4 binary. A later [four-target manual build run](https://github.com/johnny4young/puntovivo/actions/runs/34649168839)
  passed in September, but its artifacts have expired and it did not validate
  the published v1.14.4 candidate. Clean installation of v1.14.4, upgrade
  through the production updater from a previous supported signed release, and
  downgrade refusal on representative machines remain operator-run gates. The Gate 5
