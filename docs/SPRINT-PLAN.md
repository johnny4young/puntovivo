...
4. **`ENG-030..ENG-033` — AI Wave 1** — Vercel AI SDK foundation (`ENG-030`) blocks `ENG-031` and `ENG-033`; `ENG-032` (local-only anomaly) can run in parallel with the foundation work. Operator-approved provider default: Anthropic Sonnet 4.7; Ollama parked for `ENG-040`.
