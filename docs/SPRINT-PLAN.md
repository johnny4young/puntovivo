...
3. **`ENG-027..ENG-029` — remaining Phase 0 hygiene tail** — dead code removal, cross-cutting helpers, hotspot splits triggered defensively. Cheap to land, raises the floor for everything else.
