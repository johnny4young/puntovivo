...
| 2   | WC-A4 enqueue sync de lotes en venta                          | S        | offline               |
| 3   | WC-C2 sonido de checkout                                      | S        | checkout              |
| 4   | WC-C9 semáforo de cuadre en vivo                              | S        | caja                  |
| 5   | WC-C6 semáforo de margen (modo dueño)                         | S        | stock                 |
| 6   | WC-E1 property-based (dinero + FEFO)                          | S        | audit                 |
