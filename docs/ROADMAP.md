...
- Coverage thresholds are enforced in `ci:web` and `ci:server` via `vitest --coverage --run`. ENG-003b tracks raising the web thresholds back toward 70% after additional component/route tests. (Tickets `ENG-003`, `ENG-003b`)
