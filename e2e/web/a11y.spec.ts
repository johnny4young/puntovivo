/**
 * slice B — Playwright a11y smoke for the top user-facing
...
interface A11yRoute {
  ...
  settled: (
    page: Page
  ) => ReturnType<Page['locator']> | ReturnType<Page['getByRole']> | ReturnType<Page['getByText']>;
}
...
const a11yRoutes: readonly A11yRoute[] = [
  ...
  },
  {
    ...
    path: '/sales',
    role: 'cashier',
    settled: page => page.getByRole('heading', { name: /Charge summary|Resumen de cobro/i }),
  },
  {
    label: 'Sales (admin)',
    path: '/sales',
  ...
  },
  {
    ...
    path: '/inventory',
    role: 'admin',
    settled: page => page.getByRole('button', { name: /Movements|By Site|Por sede/i }).first(),
  },
  {
    label: 'Customers (admin)',
    path: '/customers',
    role: 'admin',
    settled: page => page.getByRole('button', { name: /Add Customer|Agregar cliente/i }),
  },
  {
    label: 'Products (admin)',
    path: '/products',
    role: 'admin',
    settled: page => page.getByRole('button', { name: /Add Product|Agregar producto/i }),
  },
  {
  ...
  },
  {
    ...
    // which no longer matches the post- tabbed layout.)
    settled: page =>
